...
- **[多平台同步开播操作文档.md](多平台同步开播操作文档.md)** - 完整的操作文档（v2.1）
...
```
  ...
  [⚠ WARN] OBS配置存在潜在问题
           • 配置文件「默认」码率为 4000kbps，超过淘宝直播上限(3000kbps)
...
#### 淘宝直播
- 🔴 码率限制调整为**3000kbps**（原2500kbps）
- ⚠️ 保证金个人2000-5000元，企业5000-10000元

#### 抖音直播
- 🎯 直播带货门槛确认为**200有效粉丝**（2025年4月新规生效）
- ⚠️ 视频带货需500粉丝，图文带货需1000粉丝

#### 小红书直播
- ⚠️ OBS推流需1000粉丝+注册满6个月+近3月笔记≥10篇
- 🎯 0粉可通过笔记带货（无需直播）

#### 视频号直播
- 🎯 PC微信直播仅需200粉丝或注册满7天或企业认证（三选一）
- ⚠️ OBS推流仍需1000粉丝+人脸识别验证

#### 支付宝直播（新增）
- 🆕 新增完整接入指南
- ⚠️ 需企业支付宝账号+商户入驻+芝麻信用≥650
...
| v2.1 | 2026-05-25 | 平台政策更新：五大平台推流规则刷新、新增支付宝直播 |

## 🆘 Support / 求助

遇到推流故障或有疑问？请先查阅 **[TROUBLESHOOTING.md 快速索引](TROUBLESHOOTING.md#快速索引)** —— 每个故障场景顶部都有「快速解决（≤3 步）」区块，可在 1 分钟内尝试最高命中率的修复动作。若仍未解决，再参阅 **[SUPPORT.md](SUPPORT.md)** 收集日志并通过以下渠道求助：
